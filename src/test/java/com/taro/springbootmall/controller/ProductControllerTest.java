...
public class ProductControllerTest {
    ...
    public void getProduct_success() throws Exception {
        ...
        mockMvc.perform(requestBuilder)
                ...
                .andExpect(jsonPath("$.name", equalTo("蘋果（澳洲）")))
    ...
    public void createProduct_success() throws Exception {
        ...
        productRequest.setName("test food product");
    ...
    public void getProducts_sorting() throws Exception {
        ...
        mockMvc.perform(requestBuilder)
                ...
                .andExpect(jsonPath("$.total", notNullValue()))
                .andExpect(jsonPath("$.list", hasSize(5)))
                .andExpect(jsonPath("$.list[0].id", equalTo(6)))
                .andExpect(jsonPath("$.list[1].id", equalTo(5)))
                .andExpect(jsonPath("$.list[2].id", equalTo(7)))
                .andExpect(jsonPath("$.list[3].id", equalTo(4)))
                .andExpect(jsonPath("$.list[4].id", equalTo(2)));
    }
    ...
    public void getProducts_pagination() throws Exception {
        ...
        mockMvc.perform(requestBuilder)
                ...
                .andExpect(jsonPath("$.total", notNullValue()))
                .andExpect(jsonPath("$.list", hasSize(2)))
                .andExpect(jsonPath("$.list[0].id", equalTo(5)))
                .andExpect(jsonPath("$.list[1].id", equalTo(4)));
    }
}